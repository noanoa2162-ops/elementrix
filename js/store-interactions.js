...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const texts = ['רכיבי קוד מוכנים', 'עיצובים מטורפים', 'קוד איכותי', 'חסוך זמן'];
    let textIndex = 0;
    let charIndex = 0;
    ...
    cards3d.forEach((card) => {
        ...
        cardElement.addEventListener('mousemove', (e) => {
            ...
            const shine = cardElement.querySelector('.card-3d-shine');
            if (shine) {
    ...
    if (premiumPoints) {
        premiumPoints.addEventListener('mouseenter', () => {
            const coinsParticles = premiumPoints.querySelector('.coins-particles');
            if (coinsParticles) {
